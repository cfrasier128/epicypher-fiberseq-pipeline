...
process create_qc_table {
    publishDir "$params.outdir/2_fiberseq-qc/", mode: 'copy'
    label 'large'
...
process plot_readlengths {
    ...
    script:
    """
    /opt/fiberseq/details/make-plot-readlengths.sh ${sample_id} ${qc_table} 50000 ${sample_id}.readlengths.pdf ${sample_id}.readlengths.intermediate.stat.txt
    """
}
